...
public sealed class ReconciliationResultTests
{
    ...
    public void Create_Matched_HasCorrectFields()
    {
        var result = ReconciliationResult.Create(
            ChargeId, EventId, ReconciliationStatus.Matched,
    ...
    {
        var result = ReconciliationResult.Create(
            null, EventId, ReconciliationStatus.PaymentWithoutCharge,
    ...
    {
        var result = ReconciliationResult.Create(
            ChargeId, EventId, ReconciliationStatus.AmountMismatch,
    ...
    {
        var result = ReconciliationResult.Create(
            ChargeId, EventId, status, "Reason.", 100m, 100m);
